...
public enum StringEscapePolicy implements CharSequenceTranslatorFactory {
     ...
     */
    ALL_BUT_SLASH(new AggregateTranslator(new LookupTranslator(unmodifiableMap(new HashMap<CharSequence, CharSequence>() {
     ...
     */
    ALL_BUT_UNICODE(new AggregateTranslator(new LookupTranslator(unmodifiableMap(new HashMap<CharSequence, CharSequence>() {
     ...
     */
    ALL_BUT_SLASH_AND_UNICODE(new AggregateTranslator(new LookupTranslator(Collections.unmodifiableMap(new HashMap<CharSequence, CharSequence>() {
     ...
     * Escapes all JSON special characters but slash('/') and Unicode.
     */
    DEFAULT(new AggregateTranslator(new LookupTranslator(unmodifiableMap(new HashMap<CharSequence, CharSequence>() {
